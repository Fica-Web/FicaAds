...
const FourBoxes = ({ section }) => {
    ...
    return (
        <div className="w-full bg-black min-h-[90vh] flex justify-center items-center my-20 p-20 relative">
            ...
            <div
                className="w-full min-h-[90vh] bg-cover bg-center bg-no-repeat -rotate-3 relative"
            ...
            >
                ...
                {/* Content */}
                <div className='flex flex-1 justify-center items-center min-h-[90vh] p-20 rotate-3'>
                    {/* Content Container */}
                    <div className="relative grid grid-cols-2 bg-white shadow-xl max-w-4xl">
                        ...
                        {section?.subSections?.map((section, index) => (
                            <div key={index} className="bg-gray-100 p-14 last:bg-gray2 flex items-center">
                                <div className=''>
