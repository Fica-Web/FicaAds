            ...
            >
                {herodetails.map((hero) => (
                    <div key={hero.id} className='relative w-full h-144 sm:h-144 lg:h-144 xl:h-176'>
                        ...
                        <div data-aos="fade-up" style={{ lineHeight: '1.3' }} className=' absolute bottom-0 left-0 w-full  sm:w-4/5 p-8 sm:p-6 md:w-3/5 md:p-8 lg:p-10 xl:p-16 text-white flex flex-col items-start justify-end'>
