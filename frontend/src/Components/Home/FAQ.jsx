    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between gap-0 lg:gap-16 mt-20 md:mt-10 lg:mt-28 w-full mx-auto mb-10 px-3 lg:px-20 ">
            <div className="w-full lg:w-[487px] text-center lg:text-left  pt-0 lg:pt-4 ">
                <h2 className="text-xl md:text-4xl lg:text-5xl uppercase font-Switzer-Medium lg:mb-4 mb-2 text-[#0C0C0C] leading-[40px] md:leading-[50px] lg:leading-[60px]">
                        ...
                        <AnimatePresence>
                            {openIndex === index && (
                                <motion.div
                                    ...
                                    transition={{ duration: 0.3 }}
                                    className="mt-2 font-Switzer-Light  lg:text-md text-sm  text-neutral-700 overflow-hidden"
                                >
                                    {item.answer}
                                </motion.div>
                            )}
