        ...
        <div className="flex justify-between gap-1 w-full">
           ...
           <Link
            ...
            <div className="flex flex-col items-start lg:w-[739px] ">
                ...
                <p className="text-[#0C0C0C] font-Switzer-Medium lg:text-lg font-light">{selectedService.details}</p>
            </div>
            </Link>
...
>
  <div className="leading-none" style={{ lineHeight: "0.25px" }}>
    <span
      className={`block text-xl font-mono tracking-widest ${
    ...
    <span
      className={`block lg:text-[28px] font-semibold pl-10 ${
        index === selectedIndex ? "text-[#0C0C0C]" : "text-[#0C0C0C]/50"
      }`}
    >
      {service.title}
