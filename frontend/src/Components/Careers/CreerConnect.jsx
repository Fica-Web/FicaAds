    ...
    <div className='mt-40'>
            <div className='space-y-4 md:space-y-0 md:space-x-4'>
                <div className='h-130 md:h-119 lg:h-160 xl:h-full relative'>
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-black p-4 rounded-xl space-y-2">
                        ...
                        <button className='bg-gray1 font-Switzer-Medium text-xs mt-4 rounded-xl h-8 md:h-10 p-2 px-4 text-white'>Open Positions</button>
                    </div>
