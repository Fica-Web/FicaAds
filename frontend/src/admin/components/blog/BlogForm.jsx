...
const BlogForm = ({ onSubmit, reset }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6 mt-10">
            <h2 className="text-2xl font-bold text-gray1 mb-6">
                { id ? "Edit Blog" : "Create New Blog" }
            </h2>
            <form onSubmit={handleSubmit} className="space-y-5">
                {/* Blog Title */}
                <div>
                    <label className="block text-lightgray font-medium">Title</label>
                ...
                {/* Author */}
                <div>
                    <label className="block text-lightgray font-medium">Author</label>
                ...
                {/* Category */}
                <div>
                    <label className="block text-lightgray font-medium">Category</label>
                ...
                {/* Description */}
                <div>
                    <label className="block text-lightgray font-medium">Short Description</label>
                ...
                <div className="space-y-4">
                    ...
                    {formData.content.map((section, index) => (
                        <div key={index} className="border border-gray-500 p-4 rounded-lg bg-gray-100">
                            <div>
                                <label className="block text-lightgray font-medium">Content Title</label>
                            ...
                            <div className="mt-2">
                                <label className="block text-lightgray font-medium">Content Description</label>
